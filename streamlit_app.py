...
# ----------------------------
    ...
    with col1:
        fig4 = px.scatter(health_and_lifestyle_data, x="Stress_Level", y="Quality_of_Sleep", xaxis_title='Stress Level', yaxis_title='Quality of Sleep', trendline="ols", title="Stress Levels vs Quality of Sleep", color_discrete_sequence=["#32CD32"])
